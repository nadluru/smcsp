...
pairCorr = zeros(20,noFixStep);   % For measuring the correct image reconstruction rate according to pair-wise correct measure
clusterCorr = zeros(20, noFixStep);% For measuring the correct image reconstruction rate according to cluster-wise correct measure
neighCorr = zeros(20, noFixStep);  % For measuring the correct image reconstruction rate according to neighbor-wise correct measure
ReConstructImage = cell(20, noFixStep);

%% load image
for imNo = 1:20
    imName =['C:\yxw\CVPR 2011\jigsawCode\jigsawCode\imData\', num2str(imNo), '.png'];
...
%             patchFixOrig = patchFix;
        ...
        for BPIter = 1:noBPIter
            ...
            save Jigsaw_MIT_Patch48_OneFix pairCorr clusterCorr neighCorr ReConstructImage;
        end
    end
end
% % imNo
