...
%% SMCSP
return_params=SMC_CMWS_Matching_Affinity(K,size(Ct,1),size(Ct,2),num_particles,10);
smcsp.obj=return_params.mws;
smcsp.acc=matchAsg(return_params.P, asgT);
...
%Collect.
obj(irep,:)=[asgT.obj asgGa.obj asgPm.obj asgSm.obj asgSmac.obj asgIpfpU.obj asgIpfpS.obj asgRrwm.obj asgFgmU.obj asgFgmD.obj smcsp.obj];
end
save(sprintf('myrun_%d.mat',num_particles),'obj');
