...
for num_par=800
    ...
    %for i=1:length(alpha_par)
        ...
        %return_params{i}=SMC_CMWS_Matching_linear(A1,A2,C,alpha_par(i),num_par,num_prop);
    end
    ...
    %save(sprintf('%s_vs_%s_with_dummy_corrected_no_parfor_%d.mat',graph1_name,graph2_name,num_par),'return_params','A1','A2','C','alpha_par');
    %save(sprintf('%s_vs_%s_with_dummy_linear_%d.mat',graph1_name,graph2_name,num_par),'return_params','A1','A2','C','alpha_par');
end
matlabpool close;