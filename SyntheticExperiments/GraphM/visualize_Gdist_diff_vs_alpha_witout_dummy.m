...
%% Visualization (GDist).
load(sprintf('SMC_MWS_GD_without_dummy_2x4_%d.mat',num_par))
%Graph-1.
idx=[1 3 5 7];
figure(1);clf(1);
...
savefig('gdist_vs_alpha_test_without_dummy.eps',2);
...
savefig('gdist_vs_alpha_test_simple_without_dummy.eps',2);
opooo
...
savefig('gdistdiff_vs_alpha_test_without_dummy.eps',2);
...
savefig('gdistdiff_vs_alpha_test_simple_without_dummy.eps',2);